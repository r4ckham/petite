...
<?php 
    Assets::css([
        ...
        Url::templatePath() . "plugins/element-ui/lib/theme-chalk/index.css",
    ]);
...
<?php 
    Assets::js([
        ...
        Url::templatePath() . "plugins/element-ui/lib/index.js" ,
        Url::templatePath() . "plugins/element-ui/lib/umd/locale/fr.js" ,
    ]);
?>

    <script>ELEMENT.locale(ELEMENT.lang.fr)</script>
...
<div class="wrapper">
    ...
    <header class="main-header">
        ...
        <a href="" class="logo">
            ...
            <span class="logo-mini"><b>Pe</b>tite</span>
            <!-- logo for regular state and mobile devices -->
            <span class="logo-lg">Petite</span>
        </a>
